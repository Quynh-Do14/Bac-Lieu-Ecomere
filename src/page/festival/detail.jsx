                                ...
                                <div class="description" id="description">
                                    <div class="single-full-title border-b mb-2 pb-2">
                                        <div class="single-title">
                                            ...
                                            <div class="rating-main d-sm-flex align-items-center">
                                                <p class="mb-0 mr-2"><i class="flaticon-location-pin"></i>{detailFestival.diaChi} </p>
                                    ...
                                    <div class="tour-includes mb-2">
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td>Giờ mở cửa : {convertTimeOnly(detailFestival.gioMoCua)} </td>
                                                    <td>Giờ đóng cửa : {convertTimeOnly(detailFestival.gioDongCua)} </td>
                                                    <td>Giá vé : {detailFestival.giaVe} </td>
                                                </tr>
                                                <tr>
                                                    <td>Số điện thoại liên hệ: {detailFestival.sdtLienHe}</td>
