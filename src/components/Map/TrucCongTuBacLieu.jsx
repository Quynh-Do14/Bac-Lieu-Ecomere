...
const TrucCongTuBacLieu = () => {
  ...
  const fecthData = async () => {
    ...
    map.on("load", () => {
      ...
      map.addSource("Cumtndl_polyline", {
        type: "geojson",
        data: `http://103.130.212.145:42319/api/diadiem/dataGeoJson/dataGeoJson/dataGeoJson?tenbang=Cumtndl_polyline`,
      });

      map.addLayer({
        id: "Cumtndl_polyline",
        type: "line",
        source: "Cumtndl_polyline",
        layout: {},
        paint: {
          "line-color": "#7239ea",
          "line-width": 3,
      ...
      map.addSource("Tuyendulich_MK3_polyline", {
        type: "geojson",
        data: `http://103.130.212.145:42319/api/diadiem/dataGeoJson/dataGeoJson/dataGeoJson?tenbang=Tuyendulich_MK3_polyline`,
      });
...
export default TrucCongTuBacLieu;
