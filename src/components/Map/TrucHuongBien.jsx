...
const TrucHuongBien = () => {
  ...
  const fecthData = async () => {
    ...
    map.on("load", () => {
      ...
      map.addSource("cum_TNDL_1_polyline", {
        type: "geojson",
        data: `http://103.130.212.145:42319/api/diadiem/dataGeoJson/dataGeoJson/dataGeoJson?tenbang=cum_TNDL_1_polyline`,
      });

      map.addLayer({
        id: "cum_TNDL_1_polyline",
        type: "line",
        source: "cum_TNDL_1_polyline",
        layout: {},
        paint: {
          "line-color": "#7239ea",
          "line-opacity": 0.6,
